...
//				break;
		...
		$('#anypage-path').bind('input', updatePath);

		$('#anypage-path').bind('change', checkPath);
		...
		$('body').on('click', '.anypage-invert-checkboxes', function(e) {
			e.preventDefault();

			$('input.anypage-export').each(function(i, e) {
				var $e = $(e);
